        ...
        <Box width={{ base: "300px", lg: "230px" }} marginTop={3}>
          ...
          >
            ...
            >
              <Box>
                <Image
                  src="https://images.unsplash.com/photo-1444021465936-c6ca81d39b84?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjN8fGZsb3dlcnN8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"
                  width={"100%"}
                  height={"auto"}
                  alt="image"
                  objectFit={"fill"}
